function main() {
  ...
  var sphere = new THREE.Mesh(geometry, cubeMaterial);
  sphere.position.set(-7.5, 0, 2.5);

  //create cylinder
  var geometry = new THREE.CylinderGeometry(2.5, 2.5, 5, 20);
  var cylinder = new THREE.Mesh(geometry, cubeMaterial);
  cylinder.position.set(7.5, 0, 2.5);
